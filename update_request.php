...
} elseif (isset($_POST["request_submit"])) {

  $table = "request";
  updateRequest($conn, $_POST['id'], $_POST["part_number"], $_POST["description"], $_POST["customer_code"], $_POST["customer_name"], $_POST["system_type"], $_POST["instruction_level"], $_POST["status"], $_POST["revision"], $_POST["initial_release"], $_POST["last_update"], $_POST["instruction_type"]);
}
?>
...
<div class="container d-flex justify-content-center align-items-center test">
  <div class="form-container ">
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
      <h3 class="login-text">Update Instruction Request
      </h3>
      <?php
      $message = getMessage();
      echo $message
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="input-group form-group">
                                  ...
                                  <button type="submit" class="btn-login" name="request_submit" id='request_submit'>Submit Edit
                                  </button>
                                </div>
                              <?php
                            }
