...
//Creates a new instruction once form is submitted
if (isset($_POST["add_submit"])) {
  $initialRelease = date("Y/m/d", strtotime($_POST["initial_release"]));
  $lastUpdate = date("Y/m/d", strtotime($_POST["last_update"]));
  newInstruction($conn, $_POST["part_number"], $_POST["description"], $_POST["customer_code"], $_POST["customer_name"], $_POST["system_type"], $_POST["instruction_level"], $_POST["status"], $_POST["revision"], $initialRelease, $lastUpdate, $_POST["instruction_type"]);
}
?>
...
<div class="container d-flex justify-content-center align-items-center test">
  <div class="form-container ">
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
      <h3 class="login-text">Add Instruction
      </h3>
      <?php
      //Gets error message and displays it
      $message = getMessage();
      echo $message
      ?>
